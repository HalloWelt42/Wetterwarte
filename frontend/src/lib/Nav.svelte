...
<nav class="nav">
  ...
  {#each orte as o}
    <button
      class="nav-eintrag"
      class:aktiv={aktiverOrt === o.name}
      onclick={() => (aktiverOrt = o.name)}
    >
  ...
  <button class="nav-eintrag"><i class="fa-solid fa-map-location-dot"></i> <span class="haupt">Große Karte</span></button>
