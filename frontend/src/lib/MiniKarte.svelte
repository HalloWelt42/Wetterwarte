<script lang="ts">
  ...
  // (Basiskarte, Orientierungs-Ebene, Blitze, Radar) leben PRO KACHEL-INSTANZ in
  // ihrer conf - so ist jede Karten-Kachel und jedes Profil unabhaengig. Zentriert
  // auf den Ort dieser Kachel; Aufklappen oeffnet die grosse Karten-Ansicht.
  ...
  // Overlay-Schalter der Kachel: schreiben in die conf DIESER Instanz (pro Profil).
